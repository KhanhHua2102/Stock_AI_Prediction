...
def _read_text(path):
    full_path = os.path.join(TRAINING_DATA_DIR, path)
...
def should_stop_training(loop_i, every=50):
    ...
    if loop_i % every != 0:
        return False
    try:
        with open(os.path.join(TRAINING_DATA_DIR, "killer.txt"), "r", encoding="utf-8", errors="ignore") as f:
    ...
    while True:
        while True:
            ...
            if should_stop_training(loop_i):
                ...
                # Exit the trainer process cleanly
                sys.exit(0)
                the_big_index += 1
                restarted_yet = 0
                avg50 = []
            ...
            while True:
                try:
                    ...
                    if 1 == 1:
                        try:
                            file = open(os.path.join(TRAINING_DATA_DIR, "memories_" + tf_choice + ".txt"), "r")
                            memory_list = (
                                file.read()
                                .replace("'", "")
                                .replace(",", "")
                            ...
                            file.close()
                            file = open(os.path.join(TRAINING_DATA_DIR, "memory_weights_" + tf_choice + ".txt"), "r")
                            weight_list = (
                                file.read()
                                .replace("'", "")
                                .replace(",", "")
                            ...
                            file.close()
                            file = open(
                                os.path.join(TRAINING_DATA_DIR, "memory_weights_high_" + tf_choice + ".txt"), "r"
                            )
                            high_weight_list = (
                                file.read()
                                .replace("'", "")
                            ...
                            file.close()
                            file = open(os.path.join(TRAINING_DATA_DIR, "memory_weights_low_" + tf_choice + ".txt"), "r")
                            low_weight_list = (
                                file.read()
                                .replace("'", "")
                                .replace(",", "")
